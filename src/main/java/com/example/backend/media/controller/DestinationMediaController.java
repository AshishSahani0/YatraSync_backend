...
@RestController
@RequestMapping("/api/admin/media/destinations")
@RequiredArgsConstructor
public class DestinationMediaController {
    ...
    public ResponseEntity<List<MediaUploadResponse>> uploadImages(
        ...
        List<MediaUploadResponse> response =
                mediaService.uploadDestinationImages(adminId, finalSlug, files);
    ...
    public ResponseEntity<List<MediaUploadResponse>> uploadActivityImages(
            @RequestParam("files") List<MultipartFile> files,
            @RequestParam(value = "slug", required = false) String slug,
            Authentication auth
    ) {
        ...
        List<MediaUploadResponse> response =
                mediaService.uploadActivityImages(adminId, finalSlug, files);
